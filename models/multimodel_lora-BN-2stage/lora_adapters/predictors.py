...
from ul_compat import disable_fuse
...
class VariantPredictor(BasePredictor):
    ...
    def __init__(self, yolo_model, switch_fn, n_kpts, conf=0.25, imgsz=640,
        ...
        # Fusion would collapse the shared model onto whichever group happens
        # to be active; disable it once, here, so no caller can forget.
        disable_fuse(self.model.model)
